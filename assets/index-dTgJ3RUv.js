(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var tg={exports:{}},su={},ng={exports:{}},je={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,j){var ee=z.length;z.push(j);e:for(;0<ee;){var oe=ee-1>>>1,fe=z[oe];if(0<r(fe,j))z[oe]=j,z[ee]=fe,ee=oe;else break e}}function n(z){return z.length===0?null:z[0]}function i(z){if(z.length===0)return null;var j=z[0],ee=z.pop();if(ee!==j){z[0]=ee;e:for(var oe=0,fe=z.length,Oe=fe>>>1;oe<Oe;){var We=2*(oe+1)-1,be=z[We],Z=We+1,he=z[Z];if(0>r(be,ee))Z<fe&&0>r(he,be)?(z[oe]=he,z[Z]=ee,oe=Z):(z[oe]=be,z[We]=ee,oe=We);else if(Z<fe&&0>r(he,ee))z[oe]=he,z[Z]=ee,oe=Z;else break e}}return j}function r(z,j){var ee=z.sortIndex-j.sortIndex;return ee!==0?ee:z.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],u=[],d=1,h=null,f=3,p=!1,_=!1,M=!1,g=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(z){for(var j=n(u);j!==null;){if(j.callback===null)i(u);else if(j.startTime<=z)i(u),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(u)}}function y(z){if(M=!1,x(z),!_)if(n(l)!==null)_=!0,W(A);else{var j=n(u);j!==null&&k(y,j.startTime-z)}}function A(z,j){_=!1,M&&(M=!1,c(v),v=-1),p=!0;var ee=f;try{for(x(j),h=n(l);h!==null&&(!(h.expirationTime>j)||z&&!b());){var oe=h.callback;if(typeof oe=="function"){h.callback=null,f=h.priorityLevel;var fe=oe(h.expirationTime<=j);j=t.unstable_now(),typeof fe=="function"?h.callback=fe:h===n(l)&&i(l),x(j)}else i(l);h=n(l)}if(h!==null)var Oe=!0;else{var We=n(u);We!==null&&k(y,We.startTime-j),Oe=!1}return Oe}finally{h=null,f=ee,p=!1}}var T=!1,C=null,v=-1,R=5,P=-1;function b(){return!(t.unstable_now()-P<R)}function U(){if(C!==null){var z=t.unstable_now();P=z;var j=!0;try{j=C(!0,z)}finally{j?Y():(T=!1,C=null)}}else T=!1}var Y;if(typeof m=="function")Y=function(){m(U)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,N=q.port2;q.port1.onmessage=U,Y=function(){N.postMessage(null)}}else Y=function(){g(U,0)};function W(z){C=z,T||(T=!0,Y())}function k(z,j){v=g(function(){z(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,W(A))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(z){switch(f){case 1:case 2:case 3:var j=3;break;default:j=f}var ee=f;f=j;try{return z()}finally{f=ee}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,j){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var ee=f;f=z;try{return j()}finally{f=ee}},t.unstable_scheduleCallback=function(z,j,ee){var oe=t.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?oe+ee:oe):ee=oe,z){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=ee+fe,z={id:d++,callback:j,priorityLevel:z,startTime:ee,expirationTime:fe,sortIndex:-1},ee>oe?(z.sortIndex=ee,e(u,z),n(l)===null&&z===n(u)&&(M?(c(v),v=-1):M=!0,k(y,ee-oe))):(z.sortIndex=fe,e(l,z),_||p||(_=!0,W(A))),z},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(z){var j=f;return function(){var ee=f;f=j;try{return z.apply(this,arguments)}finally{f=ee}}}})(pg);hg.exports=pg;var Tv=hg.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wv=kt,Rn=Tv;function ie(t){for(var e="https://reactjs.org/docs/error-decoder.html?invariant="+t,n=1;n<arguments.length;n++)e+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var mg=new Set,Oa={};function qr(t,e){Vs(t,e),Vs(t+"Capture",e)}function Vs(t,e){for(Oa[t]=e,t=0;t<e.length;t++)mg.add(e[t])}var Oi=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),Ic=Object.prototype.hasOwnProperty,Av=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Vh={},Hh={};function Cv(t){return Ic.call(Hh,t)?!0:Ic.call(Vh,t)?!1:Av.test(t)?Hh[t]=!0:(Vh[t]=!0,!1)}function Rv(t,e,n,i){if(n!==null&&n.type===0)return!1;switch(typeof e){case"function":case"symbol":return!0;case"boolean":return i?!1:n!==null?!n.acceptsBooleans:(t=t.toLowerCase().slice(0,5),t!=="data-"&&t!=="aria-");default:return!1}}function bv(t,e,n,i){if(e===null||typeof e>"u"||Rv(t,e,n,i))return!0;if(i)return!1;if(n!==null)switch(n.type){case 3:return!e;case 4:return e===!1;case 5:return isNaN(e);case 6:return isNaN(e)||1>e}return!1}function hn(t,e,n,i,r,s,a){this.acceptsBooleans=e===2||e===3||e===4,this.attributeName=i,this.attributeNamespace=r,this.mustUseProperty=n,this.propertyName=t,this.type=e,this.sanitizeURL=s,this.removeEmptyString=a}var $t={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(t){$t[t]=new hn(t,0,!1,t,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(t){var e=t[0];$t[e]=new hn(e,1,!1,t[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(t){$t[t]=new hn(t,2,!1,t.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(t){$t[t]=new hn(t,2,!1,t,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(t){$t[t]=new hn(t,3,!1,t.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(t){$t[t]=new hn(t,3,!0,t,null,!1,!1)});["capture","download"].forEach(function(t){$t[t]=new hn(t,4,!1,t,null,!1,!1)});["cols","rows","size","span"].forEach(function(t){$t[t]=new hn(t,6,!1,t,null,!1,!1)});["rowSpan","start"].forEach(function(t){$t[t]=new hn(t,5,!1,t.toLowerCase(),null,!1,!1)});var Ad=/[\-:]([a-z])/g;function Cd(t){return t[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(t){var e=t.replace(Ad,Cd);$t[e]=new hn(e,1,!1,t,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(t){var e=t.replace(Ad,Cd);$t[e]=new hn(e,1,!1,t,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(t){var e=t.replace(Ad,Cd);$t[e]=new hn(e,1,!1,t,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(t){$t[t]=new hn(t,1,!1,t.toLowerCase(),null,!1,!1)});$t.xlinkHref=new hn("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(t){$t[t]=new hn(t,1,!1,t.toLowerCase(),null,!0,!0)});function Rd(t,e,n,i){var r=$t.hasOwnProperty(e)?$t[e]:null;(r!==null?r.type!==0:i||!(2<e.length)||e[0]!=="o"&&e[0]!=="O"||e[1]!=="n"&&e[1]!=="N")&&(bv(e,n,r,i)&&(n=null),i||r===null?Cv(e)&&(n===null?t.removeAttribute(e):t.setAttribute(e,""+n)):r.mustUseProperty?t[r.propertyName]=n===null?r.type===3?!1:"":n:(e=r.attributeName,i=r.attributeNamespace,n===null?t.removeAttribute(e):(r=r.type,n=r===3||r===4&&n===!0?"":""+n,i?t.setAttributeNS(i,e,n):t.setAttribute(e,n))))}var Gi=wv.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,go=Symbol.for("react.element"),ys=Symbol.for("react.portal"),Ms=Symbol.for("react.fragment"),bd=Symbol.for("react.strict_mode"),Nc=Symbol.for("react.profiler"),gg=Symbol.for("react.provider"),_g=Symbol.for("react.context"),Pd=Symbol.for("react.forward_ref"),Uc=Symbol.for("react.suspense"),Fc=Symbol.for("react.suspense_list"),Ld=Symbol.for("react.memo"),tr=Symbol.for("react.lazy"),vg=Symbol.for("react.offscreen"),Gh=Symbol.iterator;function na(t){return t===null||typeof t!="object"?null:(t=Gh&&t[Gh]||t["@@iterator"],typeof t=="function"?t:null)}var Et=Object.assign,Au;function Sa(t){if(Au===void 0)try{throw Error()}catch(n){var e=n.stack.trim().match(/\n( *(at )?)/);Au=e&&e[1]||""}return`
...
`].filter(Aa).join(`
`)),a=yd(a),a=jm(a,n),a=qm(a,n),o=yd(o),o=jm(o,n),o=qm(o,n),a=$m(a),o=$m(o),n.isRawShaderMaterial!==!0&&(m=`#version 300 es
...
`)+`
`+c);const x=m+g+a,y=m+c+o,A=Wm(r,r.VERTEX_SHADER,x),T=Wm(r,r.FRAGMENT_SHADER,y);r.attachShader(M,A),r.attachShader(M,T),n.index0AttributeName!==void 0?r.bindAttribLocation(M,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function C(b){if(t.debug.checkShaderErrors){const U=r.getProgramInfoLog(M)||"",Y=r.getShaderInfoLog(A)||"",q=r.getShaderInfoLog(T)||"",N=U.trim(),W=Y.trim(),k=q.trim();let z=!0,j=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(z=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,M,A,T);else{const ee=Ym(r,A,"vertex"),oe=Ym(r,T,"fragment");qe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
Bachelor of Mathematics at Tongji University (2019.09 – 2023.06)`},{title:"Personality",content:`INFP 人格类型。热爱创意科技、设计思维和创造有意义的事物。
坚信跨学科研究的力量。

---

INFP personality type. Passionate about creative technology, design thinking, and building things that matter.
Believes in the power of interdisciplinary research.`},{title:"Interests",content:`人机交互 · 计算机视觉 · 智能设计 · 生成式模型 · 图形学
热衷于探索技术、艺术与人类体验的交汇点。

---

Human-Computer Interaction · Computer Vision · Intelligent Design · Generative Models · Graphics
Love exploring the intersection of technology, art, and human experience.`},{title:"Contact",content:`欢迎联系我进行科研合作、项目讨论，或聊聊技术与设计！
...
Feel free to reach out for research collaboration, project discussions, or just a nice chat about technology and design!
        ...
        `}]},{key:"research",label:"Research & Publications",color:"#FF0055",items:[{title:"Human-Centered GenAI",content:`<b>以人为中心的生成式模型 / Human-Centered Generative Models</b>
...
<i>arXiv 2026</i>`},{title:"Personalization",content:`<b>个性化 / Personalization</b>
...
<i>ICCV 2023</i>`},{title:"Graphics & Fabrication",content:`<b>图形学与制造 / Graphics & Fabrication</b>
...
<i>ACM Transactions on Graphics (TOG) 2026</i>`},{title:"Visualization",content:`<b>可视化 / Visualization</b>
...
<i>arXiv 2025</i>`}]},{key:"experience",label:"TBD",color:"#FF0055",items:[{title:"TBD1",content:"TBD"},{title:"TBD2",content:"TBD"},{title:"TBD3",content:"TBD"},{title:"TBD4",content:"TBD"}]},{key:"projects",label:"Projects",color:"#FF0055",items:[{title:"LLM & Agents",content:`<div class="project-item">
...
</div>`},{title:"Media Art",content:`<div class="project-item">
...
</div>`},{title:"Game Design",content:`<div class="project-item">
...
</div>`},{title:"AI & Visualization",content:`<div class="project-item">
...
</div>`}]}];function Kw(){const t=kt.useRef(null),[e,n]=kt.useState({faceIdx:0,subIdx:0}),[i,r]=kt.useState({faceIdx:0,subIdx:0}),[s,a]=kt.useState("idle"),[o,l]=kt.useState({x:-100,y:-100}),[u,d]=kt.useState(!0),h=kt.useRef(new On),f=kt.useRef(new On),p=kt.useRef(e),_=kt.useRef(!1),M=kt.useRef(!0),g=kt.useRef(null);p.current=e,kt.useEffect(()=>{const x=y=>{l({x:y.clientX,y:y.clientY})};return window.addEventListener("mousemove",x),()=>window.removeEventListener("mousemove",x)},[]),kt.useEffect(()=>{if(e.faceIdx===i.faceIdx&&e.subIdx===i.subIdx)return;a("out");const x=setTimeout(()=>{r(e),a("idle")},200);return()=>{clearTimeout(x)}},[e.faceIdx,e.subIdx]),kt.useEffect(()=>{var xe;if(!t.current)return;const x=t.current,y=document.createElement("canvas");y.width=window.innerWidth,y.height=window.innerHeight,y.style.position="absolute",y.style.top="0",y.style.left="0",y.style.pointerEvents="none",y.style.zIndex="10",(xe=x.parentElement)==null||xe.appendChild(y);const A=y.getContext("2d"),T=new qw({canvas:x,antialias:!0,alpha:!0});T.setPixelRatio(window.devicePixelRatio),T.setSize(window.innerWidth,window.innerHeight),T.setClearColor(0,0);const C=new wy,v=new Bn(50,window.innerWidth/window.innerHeight,.1,100);v.position.set(0,0,4.5),v.lookAt(0,0,0);const R=new Cm("#FFFFFF",3);R.position.set(5,5,5),C.add(R);const P=new Cm("#FFFFFF",.5);P.position.set(-5,5,-5),C.add(P),C.add(new $y("#FFFFFF",1));const b=new Yy("#FFFFFF","#FFFFFF",.5);C.add(b);const U=new wa,Y=1.4,q=[new I(1,1,1).normalize().multiplyScalar(Y),new I(1,-1,-1).normalize().multiplyScalar(Y),new I(-1,1,-1).normalize().multiplyScalar(Y),new I(-1,-1,1).normalize().multiplyScalar(Y)],N=[[0,1,2],[0,2,3],[0,3,1],[1,3,2]],W=["#FF0055","#FF0055","#FF0055","#FF0055"],k=N.map(O=>{const G=new I().copy(q[O[1]]).sub(q[O[0]]),ne=new I().copy(q[O[2]]).sub(q[O[0]]);return new I().crossVectors(G,ne).normalize()}),z=[];for(let O=0;O<4;O++)z.push({faceIdx:0,subIdx:O});const j=new I(-2,0,4.5).normalize(),ee=k.map(O=>new On().setFromUnitVectors(O,j)),oe=new On().setFromEuler(new xi(.3,.5,0));h.current.copy(oe),f.current.copy(oe);const fe=[];N.forEach((O,G)=>{const ne=q[O[0]].clone(),me=q[O[1]].clone(),De=q[O[2]].clone(),Ie=new I().addVectors(ne,me).multiplyScalar(.5),vt=new I().addVectors(me,De).multiplyScalar(.5),pt=new I().addVectors(De,ne).multiplyScalar(.5);fe.push({a:ne,b:Ie,c:pt,faceIdx:G,subIdx:0}),fe.push({a:me,b:vt,c:Ie,faceIdx:G,subIdx:1}),fe.push({a:De,b:pt,c:vt,faceIdx:G,subIdx:2}),fe.push({a:Ie,b:vt,c:pt,faceIdx:G,subIdx:3})});const Oe=new Map,We=(O,G)=>{const me=Math.round(O.x/.001)*.001,De=Math.round(O.y/.001)*.001,Ie=Math.round(O.z/.001)*.001,vt=Math.round(G.x/.001)*.001,pt=Math.round(G.y/.001)*.001,Kt=Math.round(G.z/.001)*.001,Ln=`${me},${De},${Ie}-${vt},${pt},${Kt}`,yi=`${vt},${pt},${Kt}-${me},${De},${Ie}`;return Ln<yi?Ln:yi};fe.forEach(O=>{[[O.a,O.b],[O.b,O.c],[O.c,O.a]].forEach(([ne,me])=>{const De=We(ne,me);Oe.has(De)||Oe.set(De,{a:ne.clone(),b:me.clone()})})});const be=[],Z=[],he=O=>{const G=document.createElement("canvas");G.width=512,G.height=128;const ne=G.getContext("2d",{willReadFrequently:!1});ne.clearRect(0,0,512,128),ne.fillStyle="rgba(255, 255, 255, 0.8)",ne.beginPath(),ne.roundRect(30,30,452,68,12),ne.fill(),ne.fillStyle="#1a1a2e",ne.font='700 32px -apple-system, BlinkMacSystemFont, "Segoe UI", "Helvetica Neue", sans-serif',ne.textAlign="center",ne.textBaseline="middle",ne.fillText(O,256,64);const me=new Sm(G);return me.minFilter=Ht,me.magFilter=Ht,me},ue=[["Background","Personality","Interests","Contact"],["Human-Centered GenAI","Personalization","Graphics & Fab","Visualization"],["TBD1","TBD2","TBD3","TBD4"],["LLM & Agents","Media Art","Game Design","AI & Visualization"]];fe.forEach(O=>{const G=new jt,ne=new Float32Array([O.a.x,O.a.y,O.a.z,O.b.x,O.b.y,O.b.z,O.c.x,O.c.y,O.c.z]);G.setAttribute("position",new Xt(ne,3)),G.computeVertexNormals();const me=new Mm({color:W[O.faceIdx],roughness:.3,metalness:0,transparent:!0,opacity:.8,emissive:W[O.faceIdx],emissiveIntensity:.1,side:ci}),De=new Hn(G,me);De.userData={faceIdx:O.faceIdx,subIdx:O.subIdx},U.add(De),be.push(De);const Ie=(O.a.x+O.b.x+O.c.x)/3,vt=(O.a.y+O.b.y+O.c.y)/3,pt=(O.a.z+O.b.z+O.c.z)/3,Kt=new I(Ie,vt,pt),Ln=new I,yi=new I().copy(O.b).sub(O.a),Zr=new I().copy(O.c).sub(O.a);Ln.crossVectors(yi,Zr).normalize();const Zt=Kt.clone().add(Ln.clone().multiplyScalar(.6)),ni=new jt,Mi=new Float32Array([Kt.x,Kt.y,Kt.z,Zt.x,Zt.y,Zt.z]);ni.setAttribute("position",new Xt(Mi,3));const Qr=new O_({color:0,transparent:!0,opacity:0}),Ei=new Oy(ni,Qr);Ei.userData={faceIdx:O.faceIdx,subIdx:O.subIdx},U.add(Ei);const ho=ue[O.faceIdx][O.subIdx],Jr=he(ho),po=new U_({map:Jr,transparent:!0,opacity:0,depthWrite:!1}),Wi=new Ly(po);Wi.position.copy(Zt),Wi.scale.set(1.2,.3,1),Wi.userData={faceIdx:O.faceIdx,subIdx:O.subIdx},U.add(Wi),Z.push(Wi)});const Re=new Mm({color:13421823,transparent:!0,opacity:.15,roughness:.3,metalness:0});Oe.forEach(O=>{const{a:G,b:ne}=O,me=new I().copy(ne).sub(G),De=me.length();if(De<.001)return;const Ie=new I().copy(G).add(me.clone().multiplyScalar(.5)),vt=new bh(.025,.025,De,4),pt=new Hn(vt,Re);pt.position.copy(Ie);const Kt=new I(0,1,0),Ln=new On().setFromUnitVectors(Kt,me.clone().normalize());pt.quaternion.copy(Ln),U.add(pt)}),U.position.x=2,C.add(U);const Pe=document.createElement("canvas");Pe.width=128,Pe.height=128;const Ce=Pe.getContext("2d"),rt=Ce.createRadialGradient(64,64,0,64,64,64);rt.addColorStop(0,"rgba(255, 0, 85, 0.12)"),rt.addColorStop(.5,"rgba(255, 0, 85, 0.05)"),rt.addColorStop(1,"rgba(255, 0, 85, 0)"),Ce.fillStyle=rt,Ce.fillRect(0,0,128,128);const Xe=new Sm(Pe),et=new Ch({map:Xe,transparent:!0,depthWrite:!1,blending:Fa}),lt=new fo(4,4),Be=new Hn(lt,et);Be.rotation.x=-Math.PI/2,Be.position.set(2,-1.4,0),C.add(Be);const St=50,st=new Float32Array(St*3),Bt=new Float32Array(St*3);for(let O=0;O<St*3;O+=3)st[O]=(Math.random()-.5)*15,st[O+1]=(Math.random()-.5)*15,st[O+2]=(Math.random()-.5)*12,Bt[O]=.8+Math.random()*.2,Bt[O+1]=.1+Math.random()*.2,Bt[O+2]=.3+Math.random()*.2;const D=new jt;D.setAttribute("position",new Xt(st,3)),D.setAttribute("color",new Xt(Bt,3));const Ct=new _d({size:.035,vertexColors:!0,transparent:!0,opacity:.18,sizeAttenuation:!0,blending:Fa}),ke=new vm(D,Ct);C.add(ke);const tt=15,de=new Float32Array(tt*3),ut=new Float32Array(tt*3);for(let O=0;O<tt*3;O+=3)de[O]=(Math.random()-.5)*8,de[O+1]=(Math.random()-.5)*8,de[O+2]=(Math.random()-.5)*6,ut[O]=1,ut[O+1]=.2+Math.random()*.2,ut[O+2]=.3+Math.random()*.2;const w=new jt;w.setAttribute("position",new Xt(de,3)),w.setAttribute("color",new Xt(ut,3));const S=new _d({size:.3,vertexColors:!0,transparent:!0,opacity:.08,sizeAttenuation:!0,blending:Fa}),B=new vm(w,S);C.add(B);let Q={x:0,y:0};const te=()=>{_.current=!0,M.current=!1,d(!1),g.current&&(clearTimeout(g.current),g.current=null)},se=O=>{_.current&&(L.setFromEuler(new xi((O.clientY-Q.y)*.008,(O.clientX-Q.x)*.008,0)),f.current.premultiply(L)),Q={x:O.clientX,y:O.clientY}},ce=()=>{_.current=!1};document.addEventListener("mousedown",te),document.addEventListener("mousemove",se),document.addEventListener("mouseup",ce);const $=new Qy,J=new He,pe=O=>{J.x=O.clientX/window.innerWidth*2-1,J.y=-(O.clientY/window.innerHeight)*2+1,$.setFromCamera(J,v);const G=$.intersectObjects(be);if(G.length>0){const ne=G[0].object,{faceIdx:me,subIdx:De}=ne.userData;n({faceIdx:me,subIdx:De}),M.current=!1,d(!1),g.current&&(clearTimeout(g.current),g.current=null)}};x.addEventListener("click",pe),x.addEventListener("mouseenter",()=>{M.current=!1,d(!1)});const Se=()=>{T.setSize(window.innerWidth,window.innerHeight),v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),y.width=window.innerWidth,y.height=window.innerHeight};window.addEventListener("resize",Se);let le=0,re=-1,Le=!0;const Ue=new Ye(16777215),Ze=W.map(O=>new Ye(O)),L=new On;let ae=0;const K=()=>{if(requestAnimationFrame(K),ae+=.02,M.current){if(le++,le>(Le?1:160)){le=0,re=(re+1)%z.length;const me=z[re];n(me),Le&&re>=0&&(Le=!1)}const ne=z[re>=0?re:0].faceIdx;f.current.copy(ee[ne])}h.current.slerp(f.current,.04),U.quaternion.copy(h.current),ke.rotation.x+=1e-4,ke.rotation.y+=15e-5,B.rotation.x+=5e-5,B.rotation.y-=8e-5,be.forEach(G=>{const ne=G.material,me=G.userData.faceIdx===p.current.faceIdx&&G.userData.subIdx===p.current.subIdx,De=me?.95:.8,Ie=me?.3:.1;ne.opacity+=(De-ne.opacity)*.08,ne.emissiveIntensity+=(Ie-ne.emissiveIntensity)*.08,ne.color.copy(me?Ue:Ze[G.userData.faceIdx])}),Z.forEach(G=>{const ne=G.userData.faceIdx===p.current.faceIdx,me=ne&&G.userData.subIdx===p.current.subIdx;let De=0;ne&&(De=me?1:.5);const Ie=G.material;Ie.opacity+=(De-Ie.opacity)*.12}),A.clearRect(0,0,y.width,y.height),fe.forEach(G=>{if(G.faceIdx!==p.current.faceIdx)return;const ne=(G.a.x+G.b.x+G.c.x)/3,me=(G.a.y+G.b.y+G.c.y)/3,De=(G.a.z+G.b.z+G.c.z)/3,Ie=new I(ne,me,De);Ie.applyQuaternion(U.quaternion),Ie.add(U.position);const vt=Ie.clone();vt.project(v);const pt=(vt.x*.5+.5)*y.width,Kt=(-vt.y*.5+.5)*y.height,Ln=new I,yi=new I().copy(G.b).sub(G.a),Zr=new I().copy(G.c).sub(G.a);Ln.crossVectors(yi,Zr).normalize();const Zt=new I(ne,me,De).add(Ln.clone().multiplyScalar(.6));Zt.applyQuaternion(U.quaternion),Zt.add(U.position);const ni=Zt.clone();ni.project(v);let Mi=(ni.x*.5+.5)*y.width,Qr=(-ni.y*.5+.5)*y.height;Mi=Mi-90;const Ei=G.subIdx===p.current.subIdx;A.globalAlpha=Ei?.8:.3,A.strokeStyle="#000000",A.lineWidth=.8,A.setLineDash([4,3]),A.lineCap="round",A.lineJoin="round",A.beginPath(),A.moveTo(pt+20,Kt),A.lineTo(Mi,Kt),A.lineTo(Mi,Qr),A.stroke(),A.setLineDash([])}),A.globalAlpha=1;const O=Math.sin(ae)*.02+1;Be.scale.setScalar(O),T.render(C,v)};return K(),()=>{document.removeEventListener("mousedown",te),document.removeEventListener("mousemove",se),document.removeEventListener("mouseup",ce),x.removeEventListener("click",pe),window.removeEventListener("resize",Se),y.remove(),T.dispose()}},[]);const c=$w[i.faceIdx],m=c.items[i.subIdx];return rn.jsxs("main",{className:"main-container",children:[rn.jsx("canvas",{ref:t,className:"canvas"}),rn.jsx("div",{className:"hint-text",children:"Click a triangle to explore ↩"}),rn.jsxs("div",{className:"content-panel",children:[rn.jsxs("div",{className:"panel-header",children:[rn.jsx("div",{className:"section-title",style:{color:c.color},children:c.label}),i.faceIdx===0&&rn.jsx("div",{className:"name-title",children:"Shengqi Dang".split("").map((x,y)=>{const A=["#FF0055","#FF0055","#FF0055","#FF0055"];return rn.jsx("span",{style:{color:A[y%4],opacity:.7},children:x===" "?" ":x},y)})})]}),rn.jsx("div",{className:`panel-content ${s==="out"?"slide-out":""}`,children:s!=="out"&&rn.jsx("div",{className:"content-slide",children:rn.jsx("div",{className:"item-desc",dangerouslySetInnerHTML:{__html:m.content}})},`${i.faceIdx}-${i.subIdx}`)})]}),rn.jsx("div",{className:"cursor-dot",style:{left:o.x-5,top:o.y-5,background:c.color}}),rn.jsx("div",{className:"copyright",children:"© 2026 Shengqi Dang. All rights reserved."}),u&&rn.jsx("div",{className:"auto-badge",children:"AUTO"})]})}h_(document.getElementById("root")).render(rn.jsx(kt.StrictMode,{children:rn.jsx(Kw,{})}));
