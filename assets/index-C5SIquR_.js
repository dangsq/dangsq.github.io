...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function XT(t,e,n){const i=new Float32Array(Nr),r=new I(0,1,0);return new yi({name:"SphericalGaussianBlur",defines:{n:Nr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Eu(),fragmentShader:`
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function Fm(){return new yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Eu(),fragmentShader:`
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function Om(){return new yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Eu(),fragmentShader:`
	...
	`}class W_ extends vi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new B_(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}function J1(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ra).join(`
...
#define LOW_PRECISION`),e}const ow={[xl]:"SHADOWMAP_TYPE_PCF",[Aa]:"SHADOWMAP_TYPE_VSM"};function lw(t){return ow[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const uw={[qr]:"ENVMAP_TYPE_CUBE",[Zs]:"ENVMAP_TYPE_CUBE",[yu]:"ENVMAP_TYPE_CUBE_UV"};function cw(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":uw[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const fw={[Zs]:"ENVMAP_MODE_REFRACTION"};function dw(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":fw[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const hw={[p_]:"ENVMAP_BLENDING_MULTIPLY",[KS]:"ENVMAP_BLENDING_MIX",[ZS]:"ENVMAP_BLENDING_ADD"};function pw(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":hw[t.combine]||"ENVMAP_BLENDING_NONE"}function mw(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function gw(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const l=lw(n),u=cw(n),d=dw(n),h=pw(n),f=mw(n),p=J1(n),_=ew(s),M=r.createProgram();let g,c,m=n.glslVersion?"#version "+n.glslVersion+`
...
Shengqi Dang, Yutong He, Lehao Ling, Zikang Qian, Nanxuan Zhao, Nan Cao
<i>ICCV 2025</i>

<b>CogBlender: Towards Continuous Cognitive Intervention in Text-to-Image Generation</b>
Shengqi Dang, Jie Lei, Yutong He, Zikang Qian, Nan Cao
...
Shengqi Dang, Feiran Chai, Jie Li, Chengkang Yuan, Wenwu Ye, Nan Cao
<i>AAAI 2026</i> · 1

<b>FreeShell: A Context-Free 4D Printing Technique for Fabricating Complex 3D Triangle Mesh Shells</b>
Chengkang Yuan, Shengqi Dang, Xiao Ma, Nan Cao
...
Cheng Chen, Shengqi Dang, Yifei Liu, Nanxuan Zhao, Yang Shi, Nan Cao
